...
class GameInstance:
    ...
    def load_images(self):
        self.menu_elements['MENU_BAR'] = pygame.image.load(os.path.join("Resources", "MenuElements", "menubar.png"))
        ...
        for image_name in os.listdir(
            os.path.join(os.getcwd(), "Resources", "Sprites", "Grid")
        ):
            self.grid_sprites[
                image_name[:-4]
            ] = pygame.image.load(os.path.join("Resources", "Sprites", "Grid", image_name))

        # Load faces the same way
        for image_name in os.listdir(
            os.path.join(os.getcwd(), "Resources", "Sprites", "Faces")
        ):
            self.face_sprites[
                image_name[:-4]
            ] = pygame.image.load(os.path.join("Resources", "Sprites", "Faces", image_name))

        # Load digits the same say
        for image_name in os.listdir(
            os.path.join(os.getcwd(), "Resources", "Sprites", "Digits")
        ):
            self.digit_sprites[
                image_name[:-4]
